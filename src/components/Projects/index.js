    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'data' ?
            <ToggleButton active value="data" onClick={() => setToggle('data')}>Data Analyst</ToggleButton>
            :
            <ToggleButton value="data" onClick={() => setToggle('data')}>Data Analyst</ToggleButton>
          }
          <Divider />
          {toggle === 'development' ?
